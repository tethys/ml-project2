...
\begin{minipage}{\textwidth}
  ...
  \end{tabular}
    ...
    \captionof{table}{Estimated Train and Test MAE for K-Nearest Neighbors}
\end{center}
\vspace{10 mm}
    \end{minipage}
  \end{minipage}
...
\begin{minipage}{\textwidth}
  ...
  \end{tabular}
    ...
    \captionof{table}{Estimated Train and Test MAE for different lambdas}
\end{center}
	\vspace{10 mm}
    \end{minipage}
  \end{minipage}
...
\begin{center}
  ...
  \end{tabular}
    ...
    \captionof{table}{Estimated Train and Test MAE for different features}
\end{center}
\vspace{10 mm}
    \end{minipage}
  \end{minipage}
