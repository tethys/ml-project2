...
for k_index = 1:NC
    for i = 1:nbr_iterations
        for kfold_iter = 1:K
            ...
            [clusters, cluster_assignment, train_error] = KMeans_train(full(Ytrain_new), ...
...
save('train_test_rmse_kmeans_log.mat','meanTrainRMSE', 'meanTestRMSE')
